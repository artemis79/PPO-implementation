...
if __name__ == "__main__":
                ...
                if key=='final_info':
                    for item in items:
                        if item and "episode" in item.keys():
                            ...
                            arr_returns.append(item["episode"]["r"])
                            arr_steps.append(global_step)
                            break
    ...
    # exp_name = "experiments/" + f"{args.gym_id}__{args.exp_name}__{args.seed}"
    # np.savez(exp_name, arr_returns, arr_steps)
